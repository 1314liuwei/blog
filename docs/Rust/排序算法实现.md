...
// 归并排序（循环版本）
fn merge_sort_loop(arr: &mut Vec<i32>) {
    let n = arr.len();
    if n == 1 {
        return;
    }
...
fn merge_loop(arr: &mut Vec<i32>, left: usize, mid: usize, right: usize) {
...
// 归并排序（递归版本）
fn merge_sort_recursion(arr: &mut Vec<i32>) {
    fn sort_help(arr: &mut Vec<i32>, left: usize, right: usize) {
        if right - left <= 1 {
            return;
        }
...
fn merge_recursion(arr: &mut Vec<i32>, left: usize, mid: usize, right: usize) {
